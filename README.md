...
| Platform | Download |
|---|---|
| **macOS — Apple Silicon** | [`CodeTrellis-0.1.14-arm64.dmg`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/CodeTrellis-0.1.14-arm64.dmg) — signed + notarized |
| **macOS — Intel** | [`CodeTrellis-0.1.14-x64.dmg`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/CodeTrellis-0.1.14-x64.dmg) — signed + notarized |
| **Windows — x64** | [`Setup .exe`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/CodeTrellis-Setup-0.1.14.exe) (installer) · [`Portable .exe`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/CodeTrellis-Portable-0.1.14.exe) |
| **Linux — x64** | [`.AppImage`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/CodeTrellis-0.1.14-x86_64.AppImage) · [`.deb`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/codetrellis_0.1.14_amd64.deb) · [`.rpm`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/codetrellis-0.1.14.x86_64.rpm) |
| **Linux — arm64** | [`.AppImage`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/CodeTrellis-0.1.14-arm64.AppImage) · [`.deb`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/codetrellis_0.1.14_arm64.deb) · [`.rpm`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/codetrellis-0.1.14.aarch64.rpm) |
...
| Platform | Download |
|---|---|
| **Android** | [`CodeTrellis-Companion-0.1.13.apk`](https://github.com/lionroseway/codetrellis-releases/releases/download/v0.1.13/CodeTrellis-Companion-0.1.13.apk) — sideload (see note below). **Still the 0.1.13 build**, and it will not pair with desktop 0.1.14: the pairing protocol changed. An updated companion ships via TestFlight/Play. |
...
- **Linux (AppImage)** — `chmod +x CodeTrellis-0.1.14*.AppImage && ./CodeTrellis-0.1.14*.AppImage`. Portable, no install. Pick the file matching your CPU (`-arm64` for ARM, otherwise x64).
- **Linux (.deb)** — Debian / Ubuntu: `sudo apt install ./codetrellis_0.1.14_*.deb`.
- **Linux (.rpm)** — Fedora / RHEL: `sudo dnf install ./codetrellis-0.1.14.*.rpm`.
