...
| Platform | File |
|---|---|
| **macOS — Apple Silicon** | [`CodeTrellis-0.1.4-arm64.dmg`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/CodeTrellis-0.1.4-arm64.dmg) |
| **macOS — Intel** | [`CodeTrellis-0.1.4-x64.dmg`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/CodeTrellis-0.1.4-x64.dmg) |
| **Windows — installer** | [`CodeTrellis-Setup-0.1.4.exe`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/CodeTrellis-Setup-0.1.4.exe) |
| **Windows — portable** | [`CodeTrellis-Portable-0.1.4.exe`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/CodeTrellis-Portable-0.1.4.exe) |
| **Linux — x64** | [`CodeTrellis-0.1.4.AppImage`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/CodeTrellis-0.1.4.AppImage) |
| **Linux — ARM** | [`CodeTrellis-0.1.4-arm64.AppImage`](https://github.com/lionroseway/codetrellis-releases/releases/latest/download/CodeTrellis-0.1.4-arm64.AppImage) |
...
- **Linux** — `chmod +x CodeTrellis-0.1.4.AppImage && ./CodeTrellis-0.1.4.AppImage`. Works on Debian, Ubuntu, Fedora, RHEL, Arch — no install needed.
...
```bash
./CodeTrellis-0.1.4.AppImage --no-sandbox
```
